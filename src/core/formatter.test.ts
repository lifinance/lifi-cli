...
import { formatAmount, formatDuration, formatTable, formatUsd, isJsonMode, jsonOutput } from "./formatter.js";
...
describe("formatter", () => {
  ...
  describe("isJsonMode", () => {
    ...
    it("returns true when stdout is not a TTY (piped)", () => {
      const origIsTTY = process.stdout.isTTY;
      // biome-ignore lint/suspicious/noExplicitAny: testing TTY detection requires forcing undefined onto a boolean property
